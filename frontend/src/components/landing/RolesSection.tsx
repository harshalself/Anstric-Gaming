      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Every role in your organization benefits from Anstric Gaming's intelligent knowledge system.
          </p>
        </motion.div>
            ...
            <div>
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">How Anstric Gaming helps</p>
                </div>
              </div>
