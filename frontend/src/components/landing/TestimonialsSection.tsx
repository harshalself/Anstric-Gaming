...
const testimonials = [
  {
    quote: "Anstric Gaming cut our onboarding time in half. New engineers are productive within days, not months.",
    author: "Sarah Chen",
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            See what companies are saying about transforming their knowledge management with Anstric Gaming.
          </p>
        </motion.div>
