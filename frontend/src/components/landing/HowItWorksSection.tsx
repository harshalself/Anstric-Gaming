...
const steps = [
  {
    ...
    description: "Connect your existing tools—Notion, Google Drive, GitHub, or simply upload documents. Anstric Gaming ingests and indexes everything.",
  ...
  },
  {
    ...
    icon: MessageSquare,
    title: "Ask Anything",
    description: "Employees ask questions in natural language. Anstric Gaming searches through all your documentation and provides accurate, sourced answers.",
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Get started in minutes, not months. Anstric Gaming makes knowledge management effortless.
          </p>
        </motion.div>
