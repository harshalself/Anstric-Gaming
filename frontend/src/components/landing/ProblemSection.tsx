          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-6">
                Anstric Gaming transforms your scattered documentation into a living, intelligent
            ...
            <div className="relative">
              <div className="aspect-square max-w-sm mx-auto relative">
                ...
                >
                  <span className="text-4xl font-bold text-primary-foreground">Anstric Gaming</span>
                </motion.div>
